...
public class ImageLoader {
     ...
     */
    private static int TAG_KEY_URI = R.id.movie_poster;
    /**
    ...
    public ImageLoader setImageKey(@IdRes int imageKey){
        TAG_KEY_URI = imageKey;
        return this;
    }
    ...
    public static ImageLoader build(Context context,@IdRes int imageKey){
        TAG_KEY_URI = imageKey;
